...
namespace LCBaseMod.LCBMToolKit
{
     class CreatureDataLoader{
        ...
        public static CreatureTypeInfo LoadCreatureTypeInfo(
            XmlDocument doc, 
            ref List<CreatureSpecialSkillTipTable> creatureSpecialSkillTipList, 
            ref Dictionary<long, int> specialTipSizeLib, 
            out ChildCreatureData childData
            )
        {
            XmlNode InfoNode = doc.SelectSingleNode("/creature/info");
            XmlNode ObserveNode = doc.SelectSingleNode("/creature/observe");
            XmlNode EtcNode = doc.SelectSingleNode("/creature/etc");
            XmlNode ChildNode = doc.SelectSingleNode("/creature/child");
            CreatureTypeInfo creatureTypeInfo = new CreatureTypeInfo
            {
                id = long.Parse(InfoNode.Attributes.GetNamedItem("id").InnerText)
            };
            ...
            if (ChildNode != null)
            {
                XmlNode ChildNameNode = ChildNode.SelectSingleNode("name");
                if (ChildNameNode != null)
                {
                    childCreatureData.name = ChildNameNode.InnerText;
                }
                XmlNode ChildNoNode = ChildNode.SelectSingleNode("codeId");
                if (ChildNoNode != null)
                {
                    childCreatureData.codeId = ChildNoNode.InnerText;
                }
            }
            ...
            XmlNode xmlNode7 = ObserveNode.SelectSingleNode("specialTipSize");
            if (xmlNode7 != null)
            {
                ...
                try
                {
                    while (enumerator.MoveNext())
                    {
                        XmlNode CurrentCreature = (XmlNode)enumerator.Current;
                        CreatureSpecialSkillDesc creatureSpecialSkillDesc = new CreatureSpecialSkillDesc
                        {
                            key = CurrentCreature.Attributes.GetNamedItem("key").InnerText
                        };
                        if (CurrentCreature.Attributes.GetNamedItem("openLevel") != null)
                        {
                            creatureSpecialSkillDesc.openLevel = (int)float.Parse(CurrentCreature.Attributes.GetNamedItem("openLevel").InnerText);
                        }
                        else
                        {
                        ...
                        creatureSpecialSkillDesc.desc = CurrentCreature.InnerText;
            ...
            XmlNode xmlNode9 = ObserveNode.SelectSingleNode("max");
            if (xmlNode9 != null)
            {
                ...
                if (xmlNodeList2 != null)
                {
                    ...
                    try
                    {
                        while (enumerator2.MoveNext())
                        {
                            ...
                            {
                                id = (int)float.Parse(xmlNode10.Attributes.GetNamedItem("id").InnerText),
                                selectId = (int)float.Parse(xmlNode10.Attributes.GetNamedItem("select").InnerText)
                            };
                ...
                if (xmlNodeList3 != null)
                {
                    ...
                    try
                    {
                        while (enumerator3.MoveNext())
                        {
                            ...
                            {
                                id = (int)float.Parse(xmlNode12.Attributes.GetNamedItem("id").InnerText)
                            };
                            ...
                            try
                            {
                                while (enumerator4.MoveNext())
                                {
                                    ...
                                    {
                                        desc = xmlNode13.Attributes.GetNamedItem("desc").InnerText,
                                        isAnswer = GetBooleanData(xmlNode13.Attributes.GetNamedItem("isAnswer").InnerText)
                                    };
            ...
            XmlNodeList xmlNodeList5 = InfoNode.SelectNodes("narration");
            ...
            creatureTypeInfo.MaxObserveLevel = (int)float.Parse(ObserveNode.Attributes.GetNamedItem("level").InnerText);
            XmlNode xmlNode16 = ObserveNode.SelectSingleNode("collection");
            ...
            XmlNodeList xmlNodeList6 = ObserveNode.SelectNodes("desc");
            ...
            XmlNodeList xmlNodeList7 = ObserveNode.SelectNodes("record");
            ...
            if (EtcNode != null)
            {
                XmlNodeList xmlNodeList8 = EtcNode.SelectNodes("param");
        ...
        public static CreatureTypeInfo LoadChildMeta(string currentLn, string src, ref List<CreatureSpecialSkillTipTable> creatureSpecialSkillTipList, ref Dictionary<long, int> specialTipSizeLib)
        {
            ...
            return LoadCreatureTypeInfo(xmlDocument, ref creatureSpecialSkillTipList, ref specialTipSizeLib, out ChildCreatureData childCreatureData);
        }
        ...
        private static void LoadCreatureStat(XmlNode stat, XmlNode CreatureStatData, CreatureTypeInfo model)
        {
            XmlNode CreatureScript;
            if ((CreatureScript = CreatureStatData.SelectSingleNode("script")) != null)
            {
                model.script = CreatureScript.InnerText;
            }
            XmlNode CreatureWorkAnim;
            if ((CreatureWorkAnim = CreatureStatData.SelectSingleNode("workAnim")) != null)
            {
                model.workAnim = CreatureWorkAnim.InnerText;
                XmlNode namedItem = CreatureWorkAnim.Attributes.GetNamedItem("face");
                if (namedItem != null)
                {
            ...
            XmlNode KitIcon;
            if ((KitIcon = CreatureStatData.SelectSingleNode("kitIcon")) != null)
            {
                model.kitIconSrc = KitIcon.InnerText;
            }
            XmlNode WorkType;
            if ((WorkType = stat.SelectSingleNode("workType")) != null)
            {
                string innerText = WorkType.InnerText;
                if (innerText != null)
                {
                    if (!(innerText == "normal"))
                    {
            ...
            XmlNode KeyType;
            if ((KeyType = stat.SelectSingleNode("kitType")) != null)
            {
                string innerText2 = KeyType.InnerText;
                if (innerText2 != null)
                {
                    if (!(innerText2 == "equip"))
                    {
            ...
            XmlNode MaxQliphoth;
            if ((MaxQliphoth = stat.SelectSingleNode("qliphoth")) != null)
            {
                model.qliphothMax = int.Parse(MaxQliphoth.InnerText);
            }
            XmlNode Speed;
            if ((Speed = stat.SelectSingleNode("speed")) != null)
            {
                model.speed = float.Parse(Speed.InnerText);
            }
            XmlNode CanEscape = stat.SelectSingleNode("escapeable");
            if (CanEscape != null)
            {
                bool booleanData = GetBooleanData(CanEscape.InnerText.Trim());
            ...
            XmlNode HP = stat.SelectSingleNode("hp");
            if (HP != null)
            {
                model.maxHp = (int)float.Parse(HP.InnerText);
            }
            else
            {
                model.maxHp = 5;
            ...
            try
            {
                while (enumerator.MoveNext())
                {
                    XmlNode CurrentWorkInfo = (XmlNode)enumerator.Current; ;
                    RwbpType type = ConvertToRWBP(CurrentWorkInfo.Attributes.GetNamedItem("type").InnerText);
                    IEnumerator enumerator2 = CurrentWorkInfo.SelectNodes("prob").GetEnumerator();
                    try
                    {
                        while (enumerator2.MoveNext())
                        {
                            XmlNode xmlNode11 = (XmlNode)enumerator2.Current; ;
            ...
            XmlNode WorkCooltime = stat.SelectSingleNode("workCooltime");
            if (WorkCooltime != null)
            {
                model.workCooltime = int.Parse(WorkCooltime.InnerText);
            }

            XmlNode WorkSpeed = stat.SelectSingleNode("workSpeed");
            if (WorkSpeed != null)
            {
                model.cubeSpeed = float.Parse(WorkSpeed.InnerText);
            }

            XmlNode skillTrigger = CreatureStatData.SelectSingleNode("skillTrigger");
            if (skillTrigger != null)
            {
                LoadSkillTrigger(skillTrigger, model);
            }


            Dictionary<string, string> SoundTable = new Dictionary<string, string>();
            IEnumerator enumerator3 = CreatureStatData.SelectNodes("sound").GetEnumerator();
            try
            {
                while (enumerator3.MoveNext())
                {
                    XmlNode Sound = (XmlNode)enumerator3.Current; ;
                    string innerText3 = Sound.Attributes.GetNamedItem("action").InnerText;
                    string innerText4 = Sound.Attributes.GetNamedItem("src").InnerText;
                    SoundTable.Add(innerText3, innerText4);
                }
            }
            finally
            {
            ...
            model.nodeInfo = CreatureStatData.SelectNodes("graph/node");
            model.edgeInfo = CreatureStatData.SelectNodes("graph/edge");

            XmlNode CreatureAnimSrc = CreatureStatData.SelectSingleNode("anim");
            if (CreatureAnimSrc != null)
            {
                model.animSrc = CreatureAnimSrc.Attributes.GetNamedItem("prefab").InnerText;
            }

            XmlNode ReturnImg = CreatureStatData.SelectSingleNode("returnImg");
            if (ReturnImg != null)
            {
                model.roomReturnSrc = ReturnImg.Attributes.GetNamedItem("src").InnerText;
            }
            else
            {
                model.roomReturnSrc = string.Empty;
            }
            XmlNode FeelingStateCubeBounds = stat.SelectSingleNode("feelingStateCubeBounds");
            if (FeelingStateCubeBounds != null)
            {
                List<int> list = new List<int>();
                IEnumerator enumerator4 = FeelingStateCubeBounds.SelectNodes("cube").GetEnumerator();
                try
                {
                    while (enumerator4.MoveNext())
                    {
            ...
            XmlNode WorkDamage = stat.SelectSingleNode("workDamage");
            if (WorkDamage != null)
            {
                model.workDamage = ConvertToDamageInfo(WorkDamage);
            }

            XmlNode SpecialDamage = stat.SelectSingleNode("specialDamage");
            if (SpecialDamage != null)
            {
                Dictionary<string, EquipmentTypeInfo> SpecialDamageTable = new Dictionary<string, EquipmentTypeInfo>();
                IEnumerator enumerator5 = SpecialDamage.ChildNodes.GetEnumerator();
                try
                {
                    while (enumerator5.MoveNext())
                    {
                        ...
                        if (xmlNode22.Name == "damage")
                        {
                            ...
                            SpecialDamageTable.Add(innerText5, value);
                        }
                        else if (xmlNode22.Name == "weapon")
                        {
                            ...
                            SpecialDamageTable.Add(innerText6, data);
                        }
                    }
                }
                finally
                ...
                model.creatureSpecialDamageTable.Init(SpecialDamageTable);
            }




            Dictionary<string, DefenseInfo> DefenseTable = new Dictionary<string, DefenseInfo>();
            ...
            try
            {
                while (enumerator6.MoveNext())
                {
                    ...
                    DefenseTable.Add(innerText8, defenseInfo);
                }
            }
            finally
            {
            ...
            model.defenseTable.Init(DefenseTable);



            XmlNode ObserveInfo = stat.SelectSingleNode("observeInfo");
            if (ObserveInfo != null)
            {
                List<ObserveInfoData> ObserveData = new List<ObserveInfoData>();
                IEnumerator enumerator8 = ObserveInfo.SelectNodes("observeElement").GetEnumerator();
                try
                {
                    while (enumerator8.MoveNext())
                    {
                        XmlNode xmlNode26 = (XmlNode)enumerator8.Current; ;
            ...
            List<CreatureObserveBonusData> ObserveBonus = new List<CreatureObserveBonusData>();
            ...
            try
            {
                while (enumerator10.MoveNext())
                {
                    ...
                    ObserveBonus.Add(creatureObserveBonusData);
                }
            }
            finally
            {
            ...
            model.observeBonus.Init(ObserveBonus);




            XmlNode maxWorkCount = stat.SelectSingleNode("maxWorkCount");
            if (maxWorkCount != null)
            {
                model.maxWorkCount = int.Parse(maxWorkCount.InnerText);
            }

            XmlNode maxProbReductionCounter = stat.SelectSingleNode("maxProbReductionCounter");
            if (maxProbReductionCounter != null)
            {
                model.maxProbReductionCounter = int.Parse(maxProbReductionCounter.InnerText);
            }

            XmlNode probReduction = stat.SelectSingleNode("probReduction");
            if (probReduction != null)
            {
                model.probReduction = float.Parse(probReduction.InnerText);
            }
        ...
        public static void LoadVanillaGameCreature(
            ...
            )
        {
            ...
            //原版异想体列表
            XmlDocument VanillaGameCreatureList = new XmlDocument();
            VanillaGameCreatureList.LoadXml(Resources.Load<TextAsset>("xml/CreatureList").text);


            //提取节点列表
            XmlNodeList CreatureNodes = VanillaGameCreatureList.SelectNodes("/creature_list/creature");
            ...
            try
            {
                while (CreatureNodesEnumerator.MoveNext())
                {
                    ...
                    //
                    CreatureTypeInfo creatureTypeInfo = LoadCreatureTypeInfo(CreatureLangDataXmlDoc, ref CreatureSpecialSkillTipTableList, ref specialTipSize, out ChildCreatureData ChildCreaturedata);
                    ...
                    //加载子单位Stat数据
                    XmlNode ChildCreatureStatNode = CreatureStatsDataXmlDoc.SelectSingleNode("child");

                    if (ChildCreatureStatNode != null)
                    {
                        string ChildStatSrc = ChildCreatureStatNode.InnerText;
                        ...
                        try
                        {
                            while (enumerator2.MoveNext())
                            {
                                ...
                                DefenseInfo defenseInfo = new DefenseInfo();
                                System.Collections.IEnumerator DefenseElementenumerator = xmlNode8.SelectNodes("defenseElement").GetEnumerator();
                                try
                                {
                                    while (DefenseElementenumerator.MoveNext())
                                    {
                                        object obj3 = DefenseElementenumerator.Current;
                                ...
                                {
                                    IDisposable disposable;
                                    if ((disposable = (DefenseElementenumerator as IDisposable)) != null)
                                    {
                                        disposable.Dispose();
                                    }
                                }
                        ...
                        XmlNode ChildCreatureMetaInfo = ChildStat_CreatureNode.SelectSingleNode("metaInfo");
                        if (ChildCreatureMetaInfo != null)
                        {
                            string ChiledCreatureMetaid = ChildCreatureMetaInfo.InnerText;


                            XmlDocument c_xmlDocument = AssetLoader.LoadExternalXML($"Language/{__currentLn}/creatures/{ChiledCreatureMetaid}_{__currentLn}");
                            if (c_xmlDocument == null)
                            {
                                c_xmlDocument = AssetLoader.LoadExternalXML(string.Format("Language/{0}/creatures/{1}_{0}", "en", ChiledCreatureMetaid));
                            }

                            CreatureTypeInfo creatureTypeInfo2 = LCBM_Tools_CDL.LoadChildMeta(__currentLn, ChiledCreatureMetaid, ref CreatureSpecialSkillTipTableList, ref specialTipSize);
                        ...
                        creatureTypeInfo.childTypeInfo.data = ChildCreaturedata;
                    }
            ...
            foreach (XmlDocument CreatureListXmlDoc in ex.GetCreatureListLib())
            {
                ...
                try
                {
                    while (CreatureNodesEnumerator.MoveNext())
                    {
                        ...
                        if (!BMConfigManager.Instance.AllowCreatureOverwrite.Value)
                        {
                            ex.ExpireMod();
                            StopLoadingFlag = true;
                        }
